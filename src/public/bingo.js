...
function callNumber() {
    var rand = Math.floor(Math.random() * (75-1+1)) + 1; // random number between 1 and 75
    ...
    if (calledNumbers.includes(rand))
        ...
        if (rand >= 1 && rand <= 15){
            document.getElementById("contenidoB").innerHTML = 'B' + rand;
             letra="B";
        }
        else if (rand >= 16 && rand <= 30){
            document.getElementById("contenidoB").innerHTML = 'I' + rand;
            letra="I";
         }
        else if (rand >= 31 && rand <= 45){
            document.getElementById("contenidoB").innerHTML = 'N' + rand;
            letra="N";
        }
        else if (rand >= 46 && rand <= 60){
            document.getElementById("contenidoB").innerHTML = 'G' + rand;
            letra="G";
        }
        else
        {
            document.getElementById("contenidoB").innerHTML = 'O' + rand;
            letra="O";
        }
        audioo.setAttribute('src', 'audio/'+letra+rand+'.wav'); 
        audioo.play();
    }
...
function lineBingo() {
   ...
   intervalo= setInterval('callNumber()',2000);
    goal = "line";
...
function checkCornersBingo() {
    ...
    if (sq1.style.backgroundColor == "lightblue" && calledNumbers.includes(parseInt(sq1.value)) &&
        ...
        document.getElementById("perdido").innerHTML = "Aun no hay Bingo, revisa bien tu carton";
        return;
    }
}
...
function youWin(sq1, sq2, sq3, sq4, sq5) {
    ...
    document.getElementById("perdido").innerHTML = "";
